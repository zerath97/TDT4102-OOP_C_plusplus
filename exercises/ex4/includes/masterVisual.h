...
constexpr int sizeText = 4;
constexpr int tries = 10;

constexpr int winW = 500; // velg vindu bredde
constexpr int winH = 500; // velg vindu hoyde

constexpr int padX = winW / (2*sizeText + 3);      // velg x skalering
constexpr int padY = winH / (2*tries + 2 + 1);      // velg y skalering
constexpr int radCircle = padX / (2*sizeText); // velg sirkel radius
